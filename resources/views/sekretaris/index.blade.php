            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" align="center">
                        ...
                        <p align="left"> &nbsp;&nbsp;<?php
                         ...
                         {{$pengumuman->judul}}
                         <p align="left"> <a href="{{url('sekretaris/dataPengumuman/detail', $pengumuman->id)}}" style="color: blue"> Read More </a> |
                         <a href="{{url('sekretaris/dataPengumuman/edit', $pengumuman->id)}}">Edit</a>  |
                         <a href="{{url('sekretaris/dataPengumuman/delete',$pengumuman->id)}}">Hapus</a> </p>
                         <hr>
